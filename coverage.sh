...
# as no corpus for new fuzzers will exist locally. It is up to the user to
# terminate the local servers generated by the coverage report requests.
...
function generate_report {
  ...
  sudo python3 infra/helper.py coverage --no-corpus-download $proj_name
